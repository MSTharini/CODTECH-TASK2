...
Original file is located at
    https://colab.research.google.com/drive/1TPfjvjECyWW9EYHeZjcAMqhuzebFdNwq
"""
...
"""#Checking Records of Each Kind of Transactions(Fraud Or Non-Fraud)"""
...
"""#Scaling the Amount using Standard Sclaer"""
...
"""#Spliting the Video into 80% and 20% for Training and Testing"""
...
if 'Time' in df.columns:
    ...
    # If 'Time' is not found, you might need to investigate further
    # to understand why it's missing or if it has a different name.
    # You can print the column names using:
